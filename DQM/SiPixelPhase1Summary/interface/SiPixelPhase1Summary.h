...
#include <boost/cstdint.hpp>
 ...
 protected:
    ...
    private:
       ...
       /*       MonitorElement* meSummaryMap_;
       MonitorElement* meDigiSummary_;
       MonitorElement* meADCSummary_;
       MonitorElement* meNClustsTotalSummary_;
       MonitorElement* meNClustsOnTrkSummary_;
       MonitorElement* meClustWidthOnTrkSummary_;
       MonitorElement* meClustWidthOffTrkSummary_;
       MonitorElement* meNHitsSummary_;
       MonitorElement* meEfficSummary_;
       MonitorElement* meResidualMeanSummary_;
       MonitorElement* meResidualRMSSummary_;
       */
 };
